function out = delta2chi_FANSI_nlL1TV(params)
...
tic
    ...
    if precond
        z2 =  W.*phase; % start with something similar to the input phase, weighted to reduce noise
    else
        z2 = zeros(N,'single');
    end
    s2 = zeros(N,'single'); 
